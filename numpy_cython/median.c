...
#define __PYX_HAVE__median
#define __PYX_HAVE_API__median
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "median" */
...
#define __Pyx_MODULE_NAME "median"
extern int __pyx_module_is_main_median;
int __pyx_module_is_main_median = 0;
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_6median_apply_median(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_image_path, PyObject *__pyx_v_output_path); /* proto */
...
#define __pyx_kp_u_Median_filter_applied_Saved_to __pyx_string_tab[1]
...
#define __pyx_kp_u_median_output_png __pyx_string_tab[6]
#define __pyx_kp_u_median_pyx __pyx_string_tab[7]
...
#define __pyx_n_u_apply_median __pyx_string_tab[14]
...
#define __pyx_n_u_image_path __pyx_string_tab[28]
...
#define __pyx_n_u_kx __pyx_string_tab[32]
#define __pyx_n_u_ky __pyx_string_tab[33]
#define __pyx_n_u_main __pyx_string_tab[34]
#define __pyx_n_u_median __pyx_string_tab[35]
...
#define __pyx_n_u_neighbors __pyx_string_tab[39]
...
#define __pyx_kp_b_iso88591_A_uA_RvQe6_1_t6_q_F_Rt1HCuA_as __pyx_string_tab[59]
...
/* Python wrapper */
static PyObject *__pyx_pw_6median_1apply_median(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_6median_1apply_median = {"apply_median", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6median_1apply_median, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6median_1apply_median(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("apply_median (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "apply_median", 0) < (0)) __PYX_ERR(0, 4, __pyx_L3_error)
      if (!values[1]) values[1] = __Pyx_NewRef(((PyObject*)((PyObject*)__pyx_mstate_global->__pyx_kp_u_median_output_png)));
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("apply_median", 0, 1, 2, i); __PYX_ERR(0, 4, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  2:
  ...
  __Pyx_RaiseArgtupleInvalid("apply_median", 0, 1, 2, __pyx_nargs); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("median.apply_median", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_6median_apply_median(__pyx_self, __pyx_v_image_path, __pyx_v_output_path);
...
static PyObject *__pyx_pf_6median_apply_median(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_image_path, PyObject *__pyx_v_output_path) {
  ...
  long __pyx_7genexpr__pyx_v_ky;
  long __pyx_7genexpr__pyx_v_kx;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("apply_median", 0);
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_pad); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_7 = 1;
  #if CYTHON_UNPACK_METHODS
  ...
  #endif
  {
    PyObject *__pyx_callargs[3 + ((CYTHON_VECTORCALL) ? 1 : 0)] = {__pyx_t_6, ((PyObject *)__pyx_v_pixels), __pyx_mstate_global->__pyx_int_1};
    __pyx_t_4 = __Pyx_MakeVectorcallBuilderKwds(1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_mode, __pyx_mstate_global->__pyx_n_u_edge, __pyx_t_4, __pyx_callargs+3, 0) < (0)) __PYX_ERR(0, 14, __pyx_L1_error)
  ...
  if (!(likely(((__pyx_t_1) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_1, __pyx_mstate_global->__pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 14, __pyx_L1_error)
  {
    ...
    if (unlikely((__pyx_t_9 < 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  }
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_stack); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  { /* enter inner scope */
...
*/
    for (__pyx_t_14 = 0; __pyx_t_14 < 3; __pyx_t_14+=1) {
      __pyx_7genexpr__pyx_v_ky = __pyx_t_14;
...
*/
      for (__pyx_t_15 = 0; __pyx_t_15 < 3; __pyx_t_15+=1) {
        __pyx_7genexpr__pyx_v_kx = __pyx_t_15;
 ...
 *         for kx in range(3)
*/
        __pyx_t_5 = __Pyx_PyLong_From_long(__pyx_7genexpr__pyx_v_ky); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_16 = __Pyx_PyLong_From_long((__pyx_7genexpr__pyx_v_ky + __pyx_v_h)); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_17 = PySlice_New(__pyx_t_5, __pyx_t_16, Py_None); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_17);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
        __pyx_t_16 = __Pyx_PyLong_From_long(__pyx_7genexpr__pyx_v_kx); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_5 = __Pyx_PyLong_From_long((__pyx_7genexpr__pyx_v_kx + __pyx_v_w)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_18 = PySlice_New(__pyx_t_16, __pyx_t_5, Py_None); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 17, __pyx_L1_error)
        ...
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_t_17) != (0)) __PYX_ERR(0, 17, __pyx_L1_error);
        __Pyx_GIVEREF(__pyx_t_18);
        if (__Pyx_PyTuple_SET_ITEM(__pyx_t_5, 1, __pyx_t_18) != (0)) __PYX_ERR(0, 17, __pyx_L1_error);
        __pyx_t_17 = 0;
        __pyx_t_18 = 0;
        __pyx_t_18 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_padded), __pyx_t_5); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_18);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        if (unlikely(__Pyx_ListComp_Append(__pyx_t_4, (PyObject*)__pyx_t_18))) __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  #endif
  {
    ...
    __Pyx_GOTREF(__pyx_t_18);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_axis, __pyx_mstate_global->__pyx_int_0, __pyx_t_18, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 16, __pyx_L1_error)
    __pyx_t_1 = __Pyx_Object_Vectorcall_CallFromBuilder((PyObject*)__pyx_t_6, __pyx_callargs+__pyx_t_7, (2-__pyx_t_7) | (__pyx_t_7*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_18);
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_median); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_7 = 1;
  #if CYTHON_UNPACK_METHODS
  ...
  #endif
  {
    PyObject *__pyx_callargs[2 + ((CYTHON_VECTORCALL) ? 1 : 0)] = {__pyx_t_4, __pyx_v_neighbors};
    __pyx_t_8 = __Pyx_MakeVectorcallBuilderKwds(1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_axis, __pyx_mstate_global->__pyx_int_0, __pyx_t_8, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
    __pyx_t_18 = __Pyx_Object_Vectorcall_CallFromBuilder((PyObject*)__pyx_t_5, __pyx_callargs+__pyx_t_7, (2-__pyx_t_7) | (__pyx_t_7*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_8);
    __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_uint8); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_7 = 0;
  {
...
*/
  ...
  __pyx_t_7 = 0;
  {
    ...
    __pyx_t_8 = __Pyx_PyObject_FastCallMethod((PyObject*)__pyx_mstate_global->__pyx_n_u_fromarray, __pyx_callargs+__pyx_t_7, (2-__pyx_t_7) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
    __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  __pyx_t_7 = 0;
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_18, __pyx_v_output_path};
...
*/
  __pyx_t_8 = NULL;
  __pyx_t_18 = __Pyx_PyUnicode_Unicode(__pyx_v_output_path); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_18);
  __pyx_t_6 = __Pyx_PyUnicode_Concat(__pyx_mstate_global->__pyx_kp_u_Median_filter_applied_Saved_to, __pyx_t_18); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  __pyx_t_7 = 1;
  {
...
static int __pyx_pymod_exec_median(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_median},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_median(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_median(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_median(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'median' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "median" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_median", 0);
  ...
  if (__pyx_module_is_main_median) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "median")) {
      if (unlikely((PyDict_SetItemString(modules, "median", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_6median_1apply_median, 0, __pyx_mstate_global->__pyx_n_u_apply_median, NULL, __pyx_mstate_global->__pyx_n_u_median, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetDefaultsTuple(__pyx_t_2, __pyx_mstate_global->__pyx_tuple[0]);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_apply_median, __pyx_t_2) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init median", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init median");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
 ...
 * 
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(1, ((PyObject*)__pyx_mstate_global->__pyx_kp_u_median_output_png)); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 4, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{32},{4},{179},{1},{8},{17},{10},{39},{34},{5},{1},{3},{20},{12},{5},{6},{18},{4},{17},{18},{7},{5},{4},{7},{9},{8},{1},{10},{3},{13},{5},{2},{2},{8},{6},{4},{10},{8},{9},{2},{5},{4},{6},{11},{3},{6},{6},{3},{5},{12},{4},{12},{10},{5},{8},{5},{6},{1},{195}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (694 bytes) */
const char* const cstring = "BZh91AY&SY\001w\352{\000\0005\177\373\376\377q\230s\207?@\257\347x\010\277\377\377\350@@@@@@@\000@@@\000@\000@\002=m\255s+\2345\023\ny\0051\352F\203\324z\200i\240=@\000\000\364\236\240\311\372\206)\264\324\032\201\251\221\222m&\214\010\2004\000\000\000\000\000\000\001\024\3614\321OT\375S\322zjz\233D\320\032\000\000